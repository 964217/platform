...
//            private static final String SELECT_NATIONALID = " CASE WHEN entity.entity_type = 'TENANT' THEN (select nationalid from tenant where id = entity_id)" +
//            " WHEN entity.entity_type = 'CUSTOMER' THEN (select nationalid from customer where id = entity_id) END as nationalid";
//
//             private static final String SELECT_PASSPORTID = " CASE WHEN entity.entity_type = 'TENANT' THEN (select passportid from tenant where id = entity_id)" +
//            " WHEN entity.entity_type = 'CUSTOMER' THEN (select passportid from customer where id = entity_id) END as passportid";
//
//             private static final String SELECT_STARTTIMEMS = " CASE WHEN entity.entity_type = 'TENANT' THEN (select startTimeMs from tenant where id = entity_id)" +
//            " WHEN entity.entity_type = 'CUSTOMER' THEN (select startTimeMs from customer where id = entity_id) END as startTimeMs";
//
//                         private static final String SELECT_ENDTIMEMS = " CASE WHEN entity.entity_type = 'TENANT' THEN (select endTimeMs from tenant where id = entity_id)" +
//            " WHEN entity.entity_type = 'CUSTOMER' THEN (select endTimeMs from customer where id = entity_id) END as endTimeMs";
