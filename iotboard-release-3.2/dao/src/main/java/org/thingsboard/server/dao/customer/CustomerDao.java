...
public interface CustomerDao extends Dao<Customer>, TenantEntityDao {
    ...
    // Custom Methods
    Optional<Customer> findCustomersByTenantIdAndNationalid(UUID tenantId, String nationalid);
    Optional<Customer> findCustomersByTenantIdAndPassportid(UUID tenantId, String passportid);
    Optional<Customer> findCustomersByTenantIdAndPhoneNumber(UUID tenantId, String phonenumber);
