...
public class ModelConstants {
    ...
    public static final String STARTTIMEMS_PROPERTY = "start_time_ms";
    public static final String ENDTIMEMS_PROPERTY = "end_time_ms";
    public static final String NATIONALID_PROPERTY = "nationalid";
    public static final String PASSPORTID_PROPERTY = "passportid";
    public static final String PHONE_NUMBER_PROPERTY = "phonenumber";
    public static final String ROOM_STATUS = "status";
    public static final String ROOM_HOURS = "hours";
