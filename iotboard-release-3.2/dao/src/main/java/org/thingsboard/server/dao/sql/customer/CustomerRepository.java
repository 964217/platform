...
public interface CustomerRepository extends PagingAndSortingRepository<CustomerEntity, UUID> {
    ...
    // Custom Methods
    CustomerEntity findByTenantIdAndNationalid(UUID tenantId, String nationalid);
    CustomerEntity findByTenantIdAndPassportid(UUID tenantId, String passportid);
    CustomerEntity findByTenantIdAndPhonenumber(UUID tenantId, String phonenumber);
}
