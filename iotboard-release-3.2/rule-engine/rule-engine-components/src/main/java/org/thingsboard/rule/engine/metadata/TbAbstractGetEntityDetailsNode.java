    ...
    private JsonElement setProperties(ContactBased entity, JsonElement data, EntityDetails entityDetails, String prefix) {
        ...
        switch (entityDetails) {
            ...
            case EMAIL:
                ...
                break;
              case NATIONALID:
                if (entity.getNational_ID() != null) {
                    dataAsObject.addProperty(prefix + "nationalid", entity.getNational_ID());
                }
                break;
                case PASSPORTID:
                if (entity.getPassport_ID() != null) {
                    dataAsObject.addProperty(prefix + "passportid", entity.getPassport_ID());
                }
                break;
                case STARTTIMEMS:
                if (entity.getstartTimeMs() != null) {
                    dataAsObject.addProperty(prefix + "startTimeMs", entity.getstartTimeMs());
                }
                break;
                case ENDTIMEMS:
                if (entity.getendTimeMs() != null) {
                    dataAsObject.addProperty(prefix + "endTimeMs", entity.getendTimeMs());
                }
                break;
