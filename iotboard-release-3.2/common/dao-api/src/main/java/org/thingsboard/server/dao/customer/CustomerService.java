...
public interface CustomerService {
    ...
    // Custom Methods
    Optional<Customer> findCustomerByTenantIdAndNationalId(TenantId tenantId, String nationalid);
    Optional<Customer> findCustomerByTenantIdAndPassportId(TenantId tenantId, String passportid);
    Optional<Customer> findCustomerByTenantIdAndPhoneNumber(TenantId tenantId, String phone_number);
}
