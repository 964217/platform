  ...
  private getEntityFieldKeys(entityType: EntityType, searchText: string = ''): Array<string> {
    ...
    switch (entityType) {
      ...
      case EntityType.CUSTOMER:
        ...
        entityFieldKeys.push(entityFields.phone_number.keyName);
        entityFieldKeys.push(entityFields.startTimeMs.keyName);
        entityFieldKeys.push(entityFields.endTimeMs.keyName);
        entityFieldKeys.push(entityFields.passport_ID.keyName);
        entityFieldKeys.push(entityFields.national_ID.keyName);
        entityFieldKeys.push(entityFields.status.keyName);
        entityFieldKeys.push(entityFields.hours.keyName);
        break;
      case EntityType.ENTITY_VIEW:
        entityFieldKeys.push(entityFields.name.keyName);
