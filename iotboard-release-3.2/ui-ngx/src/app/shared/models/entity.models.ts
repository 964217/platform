...
export const entityFields: {[fieldName: string]: EntityField} = {
  ...
  startTimeMs: {
    keyName: 'startTimeMs',
    name: 'entity-field.startTimeMs',
    value: 'startTimeMs'
  },
  endTimeMs: {
    keyName: 'endTimeMs',
    name: 'entity-field.endTimeMs',
    value: 'endTimeMs'
  },
 
  national_ID: {
    keyName: 'national_ID',
    name: 'entity-field.national_ID',
    value: 'national_ID'
  },
  passport_ID: {
    keyName: 'passport_ID',
    name: 'entity-field.passport_ID',
    value: 'passport_ID'
  },
  ...
  phone_number: {
    ...
    name: 'entity-field.phone_number',
    value: 'phone_number'
  },
  label: {
    keyName: 'label',
  ...
  status: {
    keyName: 'status',
    name: 'entity-field.status',
    value: 'status'
  },
  hours: {
    keyName: 'hours',
    name: 'entity-field.hours',
    value: 'hours'
  }
};
